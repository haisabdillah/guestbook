...
class GuestBookServiceClient extends \Grpc\BaseStub {
    ...
    /**
     * @param \Protobuf\Guestbook\GuestBook $argument input argument
     * @param array $metadata metadata
     * @param array $options call options
     * @return \Grpc\UnaryCall
     */
    public function GetData(\Protobuf\Guestbook\GuestBook $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/protobuf.guestbook.GuestBookService/GetData',
        $argument,
        ['\Protobuf\Guestbook\ResGuestBook', 'decode'],
        $metadata, $options);
    }
